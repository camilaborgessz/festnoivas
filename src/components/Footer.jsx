      ...
      <div style={{ maxWidth: 900, margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: 32, marginBottom: 40 }}>
          ...
          <div style={{ maxWidth: 280 }}>
            {/* Logo com fundo claro para contraste */}
            ...
            <p style={{ fontSize: 13, color: '#C4889A', lineHeight: 1.8, fontWeight: 300 }}>
              Realizando sonhos, um casamento de cada vez. Tudo em um só lugar para o dia mais especial da sua vida. 💍
            </p>
          </div>
          ...
          <div>
            ...
            {['Início', 'Quem Somos', 'Serviços', 'Eventos', 'Depoimentos', 'Formulário'].map(l => (
              <div key={l} style={{ marginBottom: 10 }}>
                <a href={`#${l === 'Início' ? 'hero' : l === 'Quem Somos' ? 'sobre' : l === 'Serviços' ? 'servicos' : l === 'Eventos' ? 'portfolio' : l === 'Depoimentos' ? 'depoimentos' : 'formulario'}`}

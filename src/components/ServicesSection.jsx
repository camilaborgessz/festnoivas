...
const servicos = [
  ...
  },
  {
    ...
    texto: 'O buffet e os drinks são o "abraço" nos convidados. É como montar um restaurante de luxo exclusivo para vocês, com chefs e barmans treinados para garantir agilidade, sabor e uma apresentação visual impecável.',
    destaques: ['Cardápio personalizado', 'Chefs e barmans treinados', 'Open bar premium', 'Mesa de doces artesanais'],
    accent: '#9B2E50',
    bg: '#FDFAF8',
  },
  {
    ...
    subtitulo: 'A energia que toma conta da festa',
    img: `${base}/imgs/luz.jpeg`,
    texto: 'A estrutura de som e iluminação garante que seus convidados saiam das cadeiras e a pista brilhe nas fotos. Somado a isso, um DJ ou banda qualificado é o termômetro da alegria, lendo a pista para manter a energia alta do início ao fim.',
    destaques: ['Sistema de som premium', 'Iluminação cênica', 'DJ ou banda qualificada', 'Termômetro da pista'],
    accent: '#7B1F3A',
    bg: '#F5E8EC',
  },
  {
    num: '04',
    titulo: 'Os Pilares',
    subtitulo: 'Assessoria, Foto, Bolo & Doces',
    img: `${base}/imgs/pilar.jpeg`,
    texto: 'A assessoria é o seu seguro-festa. A fotografia eterniza tudo. E na dupla bolo e doces usamos o bolo maquete para a estética das fotos, e o bolo de corte para garantir o frescor e o sabor servidos a todos os convidados.',
    destaques: ['Assessoria completa', 'Fotografia profissional', 'Bolo maquete + bolo de corte', 'Mesa de doces finos'],
    accent: '#9B2E50',
    bg: '#FDFAF8',
  },
];
